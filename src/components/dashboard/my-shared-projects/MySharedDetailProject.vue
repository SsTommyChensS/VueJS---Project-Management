        ...
        <div class="show-detail">
            ...
            <form id="invite-user" @submit.prevent="updateProject">
                <div class="mb-3">
                    ...
                    <img :src="project_item.image" class="img-fluid image_image" alt="Responsive image">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <QuillEditor class="descripton_quill" v-model:content="project.content" contentType="html" theme="snow"/>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3 mt-4" v-if="project_item.permission_type == 2 || project_item.permission_type == 3">
